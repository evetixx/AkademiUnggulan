                                    ...
                                    <div class="col-3">
                                        <div class="dropdown" style="float: right;">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" id="2016" onclick="showGenre(this)" href="{{route('mahasiswa.showskripsi', 19)}}">2019</a></li>
                                                <li><a class="dropdown-item" id="2017" onclick="showGenre(this)" href="{{route('mahasiswa.showskripsi', 20)}}">2020</a></li>
                                                <li><a class="dropdown-item" id="2018" onclick="showGenre(this)" href="{{route('mahasiswa.showskripsi', 21)}}">2021</a></li>
                                                <li><a class="dropdown-item" id="2019" onclick="showGenre(this)" href="{{route('mahasiswa.showskripsi', 22)}}">2022</a></li>
                                                <li><a class="dropdown-item" id="allAng" onclick="showGenre2(this)" href="{{route('mahasiswa.skripsi')}}">Semua Angkatan</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>    
             ...
             <input type="text" class="form-control"   placeholder="Search mahasiswa" id="search">
                <div class="input-group-prepend">
                 <span class="input-group-text" id="basic-addon1">
                            ...
                            <table id="tabledatamaster" class="table table-striped" style="border: 1px solid #B2D8CA; table-layout: fixed; width: 100%; font-size: 15px;">
                                ...
                                <tbody id="tabledata">
                                    <tr>
                                        ...
                                        <th scope="col">Berkas skripsi</th>
                            ...
                            <div style="float: right;"><a href="{{route('mahasiswa.chartskripsi')}}" style="text-decoration: underline;">Lihat Rekap Semua Angkatan</a></div>
                        </div>
                    </div>
                </div>
            </div>       
...
function search(){
     ...
     $.post('{{ route("mahasiswa.showskripsiajax") }}',
      {
...
for(let i = 0; i < res.datas.length; i++){
    htmlView += `
        <tr>
            ...
            <td>
            ${res.datas[i].link_skripsi? '<a class="btn btn-sm btn-info shadow" href="/downloadss/'+res.datas[i].link_skripsi+'" target="_blank" rel="noopener noreferrer" role="button">Lihat</a>' : ''}
            </td>
            <td>${res.datas[i].status_skripsi}</td>
        </tr>
    `;
}
}
