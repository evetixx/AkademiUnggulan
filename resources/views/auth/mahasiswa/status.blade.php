...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
  ...
  <script>
    ...
    function showGenre(item) {
        ...
        document.getElementById("totalMHSAngkatan").innerHTML = "Total Status Mahasiswa status Angkatan "  + item.innerHTML + ":";
    ...
    function showGenre2(item) {
        ...
        document.getElementById("totalMHSAngkatan").innerHTML = "Total Status Mahasiswa status "  + item.innerHTML + ":";
        document.getElementById("totalStatusMHS").style.display = "block";
    }
                            ...
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-9 px-4">
                                        <h5 id="titleAngkatan">Daftar Mahasiswa status</h5>
                                    </div>
                                    <div class="col-3">
                                        ...
                                        @endif
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" id="2016" onclick="showGenre(this)" href="{{route('mahasiswa.showstatus', 19)}}">2019</a></li>
                                                <li><a class="dropdown-item" id="2017" onclick="showGenre(this)" href="{{route('mahasiswa.showstatus', 20)}}">2020</a></li>
                                                <li><a class="dropdown-item" id="2018" onclick="showGenre(this)" href="{{route('mahasiswa.showstatus', 21)}}">2021</a></li>
                                                <li><a class="dropdown-item" id="2019" onclick="showGenre(this)" href="{{route('mahasiswa.showstatus', 22)}}">2022</a></li>
                                                <li><a class="dropdown-item" id="allAng" onclick="showGenre2(this)" href="{{route('mahasiswa.status')}}">Semua Angkatan</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>    
             ...
             <input type="text" class="form-control"   placeholder="Search mahasiswa" id="search">
                <div class="input-group-prepend">
                 <span class="input-group-text" id="basic-addon1">
                            ...
                            <div style="float: right;"><a href="{{route('mahasiswa.chartstatus')}}" style="text-decoration: underline;">Lihat Rekap Semua Angkatan</a></div>
                        </div>
                    </div>
                </div>
            </div>       
...
function search(){
     ...
     $.post('{{ route("mahasiswa.showstatusajax") }}',
      {
